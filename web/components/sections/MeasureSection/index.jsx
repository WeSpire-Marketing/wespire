...
export default function MeasureSection({page = '', image, title, subtitle, link, cols}) {
  if (page === 'landingTemplateSocialProof') {
    return (
      <section className="measurection bg-thriving">
        <div className="measurection-outer bg-gallery pt-[80px] pb-[80px] lg:pt-[140px] lg:pb-[110px]">
              ...
              >
                ...
                <div className="measurection-right w-full lg:w-1/2">
                  ...
                  >
                    ...
                    <p className="measurection-right__text body-m mb-8 text-secondary">
                      {subtitle}
                    </p>
